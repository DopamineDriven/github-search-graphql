...
type GitHubRepoOwnerPartial_Organization_Fragment = {
	__typename?: 'Organization';
} & Pick<
	Organization,
...
type GitHubRepoOwnerPartial_User_Fragment = {
	__typename?: 'User';
...
export type ViewerReposQuery = { __typename?: 'Query' } & {
...
`;
export const GitHubUserComprehensivePartialFragmentDoc = gql`
...
`;
export const GitHubLicenseRulePartialFragmentDoc = gql`
...
`;
export const GitHubLicensePartialFragmentDoc = gql`
	...
	${GitHubLicenseRulePartialFragmentDoc}
`;
...
`;
export const GitHubUserPartialFragmentDoc = gql`
	fragment GitHubUserPartial on User {
		id
		bio
		twitterUsername
		login
...
`;
export const GitHubReactionPartialFragmentDoc = gql`
	...
	${GitHubUserPartialFragmentDoc}
	${GitHubActorPartialFragmentDoc}
`;
export const GitHubReactionConnectionPartialFragmentDoc = gql`
	...
	${GitHubReactionPartialFragmentDoc}
	${GitHubPageInfoPartialFragmentDoc}
`;
export const GitHubIssueCommentPartialFragmentDoc = gql`
	...
	${GitHubActorPartialFragmentDoc}
	${GitHubUserPartialFragmentDoc}
	${GitHubReactionConnectionPartialFragmentDoc}
`;
export const GitHubIssuePartialFragmentDoc = gql`
	...
	${GitHubPageInfoPartialFragmentDoc}
	${GitHubIssueCommentPartialFragmentDoc}
`;
export const GitHubPinnedIssuePartialFragmentDoc = gql`
	fragment GitHubPinnedIssuePartial on PinnedIssue {
		id
		issue {
			...GitHubIssuePartial
		}
...
`;
export const GitHubRepositoryPartialFragmentDoc = gql`
	...
	${GitHubUserPartialFragmentDoc}
	${GitHubActorPartialFragmentDoc}
	${GitHubRepoOwnerPartialFragmentDoc}
	${GitHubLanguagesPartialFragmentDoc}
	${GitHubLanguagePartialFragmentDoc}
`;
...
`;
export const GitHubLabelsConnectionPartialFragmentDoc = gql`
...
`;
export const GitHubSearchResultItemConnectionPartialFragmentDoc = gql`
...
/**
 * __useViewerReposQuery__
 *
 * To run a query within a React component, call `useViewerReposQuery` and pass it any options that fit your needs.
 * When your component renders, `useViewerReposQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useViewerReposQuery(
	baseOptions?: Apollo.QueryHookOptions<
		ViewerReposQuery,
	...
	return Apollo.useQuery<
		ViewerReposQuery,
		ViewerReposQueryVariables
	>(ViewerReposDocument, options);
}
export function useViewerReposLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		ViewerReposQuery,
		ViewerReposQueryVariables
	>
...
export type ViewerReposQueryHookResult = ReturnType<
	typeof useViewerReposQuery
>;
export type ViewerReposLazyQueryHookResult = ReturnType<
	typeof useViewerReposLazyQuery
>;
...
export type GetViewerQueryHookResult = ReturnType<
	typeof useGetViewerQuery
>;
